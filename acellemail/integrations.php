  ...
  <div class="mc-container">
    ...
    <div class="mc-grid mc-grid--3 mc-grid--gap-lg">
      ...
      <a href="integrations.php" class="mc-card mc-card--bordered" style="text-decoration: none; color: inherit;">
        ...
        <div class="mc-card__body" style="padding: var(--space-lg);">
          <div style="display: flex; align-items: center; gap: var(--space-sm); margin-bottom: var(--space-md);">
            <img src="images/integrations/stripe.png" alt="Stripe" style="width: 32px; height: 32px; border-radius: var(--radius-sm);">
...
<section class="mc-section mc-section--cream" id="verification">
  <div class="mc-container">
    ...
    <div class="mc-grid mc-grid--4 mc-grid--gap-md">
      ...
      <!-- AWS S3 Storage -->
      <a href="integrations.php" class="mc-card mc-card--bordered" style="text-decoration: none; color: inherit;" id="storage">
        <div class="mc-card__body" style="padding: var(--space-lg);">
          <div style="display: flex; align-items: center; gap: var(--space-md); margin-bottom: var(--space-md);">
  ...
  <div class="mc-container">
    <div style="display: flex; align-items: center; justify-content: space-between; background: var(--mc-light-gray); border-radius: var(--radius-lg); padding: var(--space-2xl) var(--space-3xl); flex-wrap: wrap; gap: var(--space-lg);">
      ...
      <div style="display: flex; gap: var(--space-md); flex-wrap: wrap;">
        <a href="pricing.php" class="mc-btn mc-btn--primary">Get Started</a>
        <a href="features.php" class="mc-link mc-link--arrow" style="font-size: 16px; font-weight: 500; display: flex; align-items: center; color: var(--mc-teal); text-decoration: none;">View all features &rarr;</a>
      </div>
    </div>
  </div>
</section>
