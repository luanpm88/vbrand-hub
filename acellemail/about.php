...
<section class="mc-about-hero">
  <img src="images/hero/about-hero.jpg" alt="AcelleMail headquarters" class="mc-about-hero__image">
    ...
    <div class="mc-grid mc-grid--3 mc-grid--gap-lg">
      ...
      <a href="https://acellemail.com" class="mc-card mc-card--bordered">
        <div class="mc-card__image mc-card__image--fixed">
          <img src="images/about/newsroom.jpg" alt="AcelleMail Documentation">
        </div>
      ...
      <a href="features.php" class="mc-card mc-card--bordered">
        <div class="mc-card__image mc-card__image--fixed">
          <img src="images/about/why-acellemail.jpg" alt="See what's new in every release">
        </div>
        <div class="mc-card__body">
      ...
      <a href="https://acellemail.com" class="mc-card mc-card--bordered">
        <div class="mc-card__image mc-card__image--fixed">
          <img src="images/about/whats-new.png" alt="AcelleMail Community">
        </div>
        <div class="mc-card__body">
