<?php $current_page = 'email-marketing'; ?>
    ...
    <div class="mc-container">
        <div class="mc-hero__grid">
            ...
            <div class="mc-hero__image">
                <img src="images/features/email-sms.svg" alt="AcelleMail email marketing platform — design, send, and analyze email campaigns">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/email-sms.svg" alt="Drag-and-drop email builder interface">
            </div>
    ...
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">Browse all templates &rarr;</a>
            </div>
            <div class="mc-feature-alt__image">
                <img src="images/features/automations-ecom.svg" alt="Professional email templates for every industry">
            </div>
        </div>
    </div>
</section>
...
<section class="mc-feature-alt" style="background: var(--mc-light-gray);">
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/predictive.svg" alt="Advanced audience segmentation tools">
            </div>
            <div class="mc-feature-alt__content">
    ...
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">Learn about testing &rarr;</a>
            </div>
            <div class="mc-feature-alt__image">
                <img src="images/features/automations-ecom.svg" alt="A/B testing dashboard showing campaign variations and results">
            </div>
        </div>
    </div>
</section>
...
<section class="mc-feature-alt" style="background: var(--mc-light-gray);">
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/sending-servers.svg" alt="Sending server management">
            </div>
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">Learn about sending servers &rarr;</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mc-container">
        <div class="mc-case-study__inner">
            <div class="mc-case-study__image">
                <img src="images/features/case-study.png" alt="Cost savings case study — self-hosted email marketing">
            </div>
            <div class="mc-case-study__content">
                ...
                <a href="about.php" class="mc-case-study__link">Read the full case study <span>&rarr;</span></a>
            </div>
        </div>
    </div>
</section>
...
<section class="mc-section" style="background: var(--mc-cream);">
    <div class="mc-container">
        ...
        <div class="mc-grid mc-grid--3 mc-grid--gap-lg">
            <a href="features.php" class="mc-card mc-card--bordered" style="background: var(--mc-white);">
                <div class="mc-card__body mc-card__body--lg">
                    <div style="font-size: 40px; margin-bottom: var(--space-md);">
...
<section class="mc-feature-alt">
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/predictive.svg" alt="Email marketing analytics and reporting dashboard">
            </div>
            <div class="mc-feature-alt__content">
    ...
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__content">
                ...
                <a href="automation.php" class="mc-feature-alt__link">Explore automations &rarr;</a>
            </div>
            <div class="mc-feature-alt__image">
                <img src="images/features/automations-ecom.svg" alt="Email automation builder with triggers and workflows">
            </div>
        </div>
    </div>
</section>
