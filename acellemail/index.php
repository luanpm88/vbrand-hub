        ...
        <div class="mc-hero__grid">
            <div class="mc-hero__content">
                ...
                <div class="mc-hero__reviews">
                    <img src="images/icons/stars-4-5.png" alt="4.6 stars" class="mc-hero__stars">
            ...
            <div class="mc-hero__image">
                <img src="images/hero/home-hero.svg" alt="AcelleMail email marketing platform">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="mc-feature-cards__grid">
            <div class="mc-feature-cards__item">
                <div class="mc-feature-cards__image">
                    <img src="images/features/email-sms.svg" alt="Email marketing">
                </div>
                ...
                <a href="features.php" class="mc-feature-cards__link">Learn about the email builder &rarr;</a>
            </div>
            <div class="mc-feature-cards__item">
                <div class="mc-feature-cards__image">
                    <img src="images/features/automations-ecom.svg" alt="Marketing automation">
                </div>
                ...
                <a href="features.php" class="mc-feature-cards__link">Explore automation features &rarr;</a>
            </div>
            <div class="mc-feature-cards__item">
                <div class="mc-feature-cards__image">
                    <img src="images/features/switch-brands.svg" alt="Marketing automation">
                </div>
                ...
                <a href="features.php" class="mc-feature-cards__link">See why self-hosted wins &rarr;</a>
            </div>
        </div>
    </div>
</section>
...
<section class="mc-services-showcase">
    <div class="mc-container">
        ...
        <div class="mc-services-showcase__grid">
            <div class="mc-services-showcase__item"><img src="images/services/amazon-ses-logo.svg" alt="Amazon SES"></div>
            <div class="mc-services-showcase__item"><img src="images/services/sendgrid-logo.svg" alt="SendGrid"></div>
            <div class="mc-services-showcase__item"><img src="images/services/sparkpost-logo.svg" alt="SparkPost"></div>
            <div class="mc-services-showcase__item"><img src="images/services/mailgun-logo.svg" alt="Mailgun"></div>
            <div class="mc-services-showcase__item"><img src="images/services/postmark-logo.svg" alt="Postmark"></div>
            <div class="mc-services-showcase__item"><img src="images/services/elastic-email-logo.svg" alt="Elastic Email"></div>
        </div>
    </div>
</section>
    ...
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/email-sms.svg" alt="Drag-and-drop email builder">
            </div>
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">Explore the email builder &rarr;</a>
            </div>
        </div>
    </div>
</section>
...
<section class="mc-feature-alt mc-feature-alt--reverse" style="background: var(--mc-cream);">
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/automations-ecom.svg" alt="Marketing automation workflows">
            </div>
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">See all automations &rarr;</a>
            </div>
        </div>
    </div>
</section>
...
<section class="mc-feature-alt">
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/predictive.svg" alt="Email analytics dashboard">
            </div>
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">Explore analytics &rarr;</a>
            </div>
        </div>
    </div>
</section>
...
<section class="mc-feature-alt" style="background: var(--mc-light-gray);">
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/reach-inboxes.png" alt="Marketing automation">
            </div>
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">Learn about deliverability &rarr;</a>
            </div>
        </div>
    </div>
</section>
...
<section class="mc-feature-alt mc-feature-alt--reverse">
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/predictive.svg" alt="List management and segmentation">
            </div>
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">Explore list management &rarr;</a>
            </div>
        </div>
    </div>
</section>
...
<section class="mc-section">
    <div class="mc-container">
        ...
        <div class="mc-grid mc-grid--2 mc-grid--gap-lg">
            <a href="features.php" class="mc-card mc-card--bordered">
                <div class="mc-card__image mc-card__image--fixed">
                    <img src="images/features/automations-ecom.svg" alt="Multi-tenant SaaS platform">
                </div>
            ...
            <a href="features.php" class="mc-card mc-card--bordered">
                <div class="mc-card__image mc-card__image--fixed">
                    <img src="images/features/predictive.svg" alt="Subscription billing and plans">
                </div>
                <div class="mc-card__body">
        ...
        <div class="mc-feature-row">
            <div class="mc-feature-row__content">
                ...
                <div class="mc-hero__actions">
                    ...
                    <a href="pricing.php" class="mc-btn mc-btn--secondary">See pricing</a>
                </div>
            </div>
            <div class="mc-feature-row__image">
                <img src="images/features/email-sms.svg" alt="Laravel PHP source code">
            </div>
        </div>
    </div>
</section>
...
<section class="mc-section">
    <div class="mc-container">
        <div class="mc-feature-row mc-feature-row--reverse">
            ...
            <div class="mc-feature-row__image">
                <img src="images/features/installation_setup.svg" alt="Easy installation on any server">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mc-container">
        <div class="mc-case-study__inner">
            <div class="mc-case-study__image">
                <img src="images/features/case-study-savings.svg" alt="Savings case study">
            </div>
            <div class="mc-case-study__content">
                ...
                <a href="about.php" class="mc-case-study__link">Read the full story &rarr;</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mc-container">
        <div class="mc-providers-banner__inner">
            ...
            <div class="mc-providers-banner__logos">
                <img src="images/services/amazon-ses-logo.svg" alt="Amazon SES">
                <img src="images/services/sendgrid-logo.svg" alt="SendGrid">
                <img src="images/services/sparkpost-logo.svg" alt="SparkPost">
                <img src="images/services/mailgun-logo.svg" alt="Mailgun">
                <img src="images/services/postmark-logo.svg" alt="Postmark">
                <img src="images/services/elastic-email-logo.svg" alt="Elastic Email">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mc-container">
        ...
        <div class="mc-grid mc-grid--3 mc-grid--gap-lg">
            <a href="https://acellemail.com" class="mc-card mc-card--bordered">
                <div class="mc-card__image mc-card__image--fixed">
                    <img src="images/about/newsroom.jpg" alt="Installation Guide">
                </div>
                <div class="mc-card__body">
            ...
            <a href="https://demo.acellemail.com" class="mc-card mc-card--bordered">
                <div class="mc-card__image mc-card__image--fixed">
                    <img src="images/about/why-acellemail.jpg" alt="Live Demo">
                </div>
                <div class="mc-card__body">
            ...
            <a href="https://acellemail.com" class="mc-card mc-card--bordered">
                <div class="mc-card__image mc-card__image--fixed">
                    <img src="images/about/whats-new.png" alt="Changelog">
                </div>
                <div class="mc-card__body">
