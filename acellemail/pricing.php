...
<section class="mc-pricing-hero" style="background-color: var(--mc-cream);">
    <div class="mc-container">
        <div class="mc-pricing-hero__tabs">
            <a href="pricing.php" class="mc-pricing-hero__tab mc-pricing-hero__tab--active">One-Time Pricing</a>
            <a href="features.php" class="mc-pricing-hero__tab">All Features</a>
            <a href="contact.php" class="mc-pricing-hero__tab">Custom Solutions</a>
        </div>
        <div class="mc-pricing-hero__grid">
            ...
            <div class="mc-pricing-hero__image">
                <img src="images/features/pricing-hero.svg" alt="Simple, One-Time Pricing" style="width:100%;border-radius:var(--radius-lg);">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="mc-pricing-plans__grid">
            ...
            <div class="mc-pricing-plans__card">
                ...
                <div class="mc-pricing-plans__card-footer">
                    <a href="https://codecanyon.net/item/acelle-email-marketing-web-application/17796082" class="mc-btn mc-btn--primary">Buy Now</a>
                    <a href="features.php" class="mc-btn mc-btn--outline">See All Features</a>
                </div>
            </div>
            ...
            <div class="mc-pricing-plans__card mc-pricing-plans__card--featured">
                ...
                <div class="mc-pricing-plans__card-footer">
                    ...
                    <a href="features.php" class="mc-btn mc-btn--outline">Compare Licenses</a>
                </div>
            </div>
            ...
            <div class="mc-pricing-plans__card">
                ...
                <div class="mc-pricing-plans__card-footer">
                    ...
                    <a href="contact.php" class="mc-btn mc-btn--outline">Ask a Question</a>
                </div>
            </div>
...
<section class="mc-services-bar">
    <div class="mc-container">
        ...
        <div class="mc-services-bar__logos">
            <div class="mc-services-bar__item"><img src="images/services/amazon-ses.svg" alt="Amazon SES" width="36" height="36"><span>Amazon SES</span></div>
            <div class="mc-services-bar__item"><img src="images/services/sendgrid.svg" alt="SendGrid" width="36" height="36"><span>SendGrid</span></div>
            <div class="mc-services-bar__item"><img src="images/services/sparkpost.svg" alt="SparkPost" width="36" height="36"><span>SparkPost</span></div>
            <div class="mc-services-bar__item"><img src="images/services/mailgun.svg" alt="Mailgun" width="36" height="36"><span>Mailgun</span></div>
            <div class="mc-services-bar__item"><img src="images/services/postmark.svg" alt="Postmark" width="36" height="36"><span>Postmark</span></div>
            <div class="mc-services-bar__item"><img src="images/services/elastic-email.svg" alt="Elastic Email" width="36" height="36"><span>Elastic Email</span></div>
        </div>
    </div>
</section>
    ...
    <div class="mc-container">
        <div class="mc-feature-alt__grid">
            <div class="mc-feature-alt__image">
                <img src="images/features/email-sms.svg" alt="Sending cost comparison chart">
            </div>
            <div class="mc-feature-alt__content">
                ...
                <a href="features.php" class="mc-feature-alt__link">See all supported sending services &rarr;</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="mc-container">
        <div class="mc-case-study__inner">
            <div class="mc-case-study__image">
                <img src="images/features/case-study-savings.svg" alt="Save $12,000+ per year" style="width:100%;border-radius:var(--radius-lg);">
            </div>
...
<section class="mc-section mc-section--cream mc-section--lg">
    <div class="mc-container">
        <div style="max-width: 680px; margin: 0 auto; text-align: center;">
            ...
            <a href="contact.php" class="mc-btn mc-btn--primary mc-btn--lg">Contact Our Team</a>
        </div>
    </div>
</section>
