    ...
    <div class="login-card">
        <div class="text-center mb-4">
            <a href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('images/kb-icon.svg')); ?>" alt="" width="48" height="48" class="mb-2">
            </a>
            ...
            <div class="card-body p-4">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username">
                    </div>
        ...
        <p class="text-center mt-3 small text-muted">
            <a href="<?php echo e(route('home')); ?>" class="text-decoration-none">&larr; Back to Knowledge Base</a>
        </p>
    </div>
</body>
</html>
<?php /**PATH /Users/luan/apps/vbrand/kb/resources/views/auth/login.blade.php ENDPATH**/ ?>