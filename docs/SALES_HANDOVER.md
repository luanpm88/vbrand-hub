...
| 7 | **Mẫu nào thuận tiện nhất để chào khách?** | Gửi demo **theo ngành khách** (Cafe → GuuCoffee / CafeDanhPhát, Vịt quay / F&B truyền thống → Võ Đức, Organic/thực phẩm sạch → Orgafood, Tech → Logitech, Thời trang → Nike). Chưa rõ ngành → gửi cả 4. Chiến lược tốt nhất: gửi link demo + nói "tạo site riêng cho anh/chị trong 15 phút". | [Mục 8](#8-mẫu-nào-tốt-nhất-để-đi-chào-khách) |
...
| 9 | **Võ Đức — Vịt Quay Da Giòn** | https://voducfoods.b-teka.com | voducfoods | Vịt quay sỉ & lẻ + Đào tạo nghề (Giòn · Ngon · Chất, Đồng Nai) |
...
| Võ Đức — Vịt Quay Da Giòn | `voducfoods@gmail.com` | `123456` |
...
| **voducfoods** | Vịt quay sỉ & lẻ + đào tạo nghề (palette son đỏ + vàng kim, badge logo võ thuật) | https://voducfoods.b-teka.com |
...
| Cà phê Danh Phát | https://cafedanhphat.vn/wp-admin | `admin` | `aA456321@` |
| Võ Đức — Vịt Quay Da Giòn | https://voducfoods.b-teka.com/wp-admin | `admin` | `aA456321@` |
